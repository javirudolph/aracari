...
save(bias_df, file = paste0("Ch3_samplesize/", dir_scenario, "/nonparam_bias_reps.RData"))
...
save(bias_df, file = paste0("Ch3_samplesize/", dir_scenario, "/param_bias_reps.RData"))
