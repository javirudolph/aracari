...
```{r Fig4, fig.width=12, fig.height=5}
...
allin1df %>%
  ...
  facet_wrap(~labelsamp, nrow = 2) +
  geom_boxplot() +
  scale_color_manual(values = pal_mixture[c(1,4)], name = "Bias") +
  scale_fill_manual(values = pal_mixture[c(2,3)], name = "Bias") +
  geom_hline(yintercept = 0, color = "red") +
