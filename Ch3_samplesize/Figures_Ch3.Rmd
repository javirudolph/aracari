...
ableg <- get_legend(b + theme(legend.position = "right"))
...
corr_a %>% 
  ...
  geom_point(aes(y = log(theta)), size = 3, shape = 18, color = theta_color, show_guide = FALSE) +
  scale_fill_manual(values = c("grey47", "white"), name = "") +
  labs(x = "Long-distance level", y = "Estimated theta", title = corr_a$correctiontype[1]) +
  theme_bw() +
...
corr_b %>% 
  ...
  geom_point(aes(y = log(theta)), size = 3, shape = 18, color = theta_color, show_guide = FALSE) +
  scale_fill_manual(values = c("grey47", "white"), name = "") +
  labs(x = "Long-distance level", y = "Estimated theta", title = corr_b$correctiontype[1]) +
  theme_bw() +
