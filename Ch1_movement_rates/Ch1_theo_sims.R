...
save.image(file = paste0("Ch1_movement_rates/novar_sims_", Sys.Date(), ".RData"))
...
save.image(file = paste0("Ch1_movement_rates/novar_weibulldisp_", Sys.Date(), ".RData"))
...
save.image(file = paste0("Ch1_movement_rates/novar_weibull2run_", Sys.Date(), ".RData"))
