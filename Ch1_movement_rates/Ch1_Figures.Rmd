...
points_plot <- function(seed.data, summ.data, s.size = 5000, xylims=1250, lalpha = 0.5, scenario = NULL, twoplots = FALSE){
  ...
  seed.data %>% 
    ...
    sample_n(s.size) %>% 
      ...
      geom_text(label = scenario, x = -1000, y = -1000, color = "black") +
