...
cp.dens +
  ...
  theme(panel.background = element_rect(fill = backgroundcol),
        axis.title.y = element_blank()) -> cp.tail

pp.dens +
  coord_cartesian(xlim = c(600, 1000), ylim = c(0, 0.0001)) +
  theme(panel.background = element_rect(fill = backgroundcol),
        axis.title.y = element_blank()) -> pp.tail

np.dens +
  coord_cartesian(xlim = c(600, 1000), ylim = c(0, 0.0001)) +
  theme(panel.background = element_rect(fill = backgroundcol),
        axis.title.y = element_blank()) -> np.tail
...
```{r KernelGrid}
plot_grid(kernelcurvesfig, kernel_tails_fig, ncol = 2, labels = c("A)", "B)"), hjust = 0, vjust = 1, label_size = 10)
```
