...
ggplot() +
  ...
  lims(x = c(0, 1250), y = c(0, 0.006)) +
  theme_bw() +
  labs(y = "Density", x = "Dispersal (m)") -> cp.dens
...
ggplot() +
  ...
  lims(x = c(0, 1250), y = c(0, 0.006)) +
  theme_bw() +
  labs(y = "Density", x = "Dispersal (m)") -> pp.dens
...
ggplot() +
  ...
  lims(x = c(0, 1250), y = c(0, 0.006)) +
  theme_bw() +
  labs(y = "Density", x = "Dispersal (m)") -> np.dens

plot_grid(cp.dens, pp.dens, np.dens, nrow = 3)
...
```{r}
cp.dens +
  coord_cartesian(xlim = c(500, 1000), ylim = c(0, 0.0001)) -> cp.tail

pp.dens +
  coord_cartesian(xlim = c(500, 1000), ylim = c(0, 0.0001)) -> pp.tail

np.dens +
  coord_cartesian(xlim = c(500, 1000), ylim = c(0, 0.0001)) -> np.tail
