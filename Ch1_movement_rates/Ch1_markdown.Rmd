...
weib.boot %>% 
  ggplot(., aes(x = factor(indiv), y = est.shape)) +
  geom_violin() +
 ...
 **NEXT** Instead of the violin plots, I should show the dispersal kernels created by each of these bootstrap replicates.   
 Also, seems like for simulations, we need to sample 5 individuals multiple times, or sample more than 5 individuals from each population. I like the second approach because it resembles just sampling more individuals in the field, increasing your sample size to get a better picture of nature.
 Also, edit colors in violin plots to show each individuals color, and only use the one that includes the population as well. Leave population in black. Change red lines and dot to black too. 
