 ...
 **NEXT** Instead of the violin plots, I should show the dispersal kernels created by each of these bootstrap replicates.   
 Also, seems like for simulations, we need to sample 5 individuals multiple times, or sample more than 5 individuals from each population. I like the second approach. 
