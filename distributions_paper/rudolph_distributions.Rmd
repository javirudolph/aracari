...
So, for each individual, which is the best fitting distribution, based on AIC or BIC? Here we are just focusing on the model fits for each individual. 
...
prms_ic %>% 
  ...
  mutate(agree = ifelse(deltaAIC == deltaBIC, "yes", "no"))
```
