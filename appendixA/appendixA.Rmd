...
ind_dens_plot +
  annotation_custom(grob = ggplotGrob(ind_zoom), xmin = 50 , xmax = 250 , ymin = 0.02 , ymax = 0.04) -> a
...
fam_dens_plot +
  annotation_custom(grob = ggplotGrob(fam_zoom), xmin = 100 , xmax = 200 , ymin = 0.02 , ymax = 0.05) -> b
